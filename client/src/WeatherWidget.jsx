...
export default function WeatherWidget() {
  ...
  return (
    <div className={`relative ${style.bg} ${style.text} p-4 sm:p-6 md:p-8 shadow-md border-y border-white/10 overflow-hidden w-full transition-all duration-1000 text-slate-800 animate-in fade-in duration-300`}>
      ...
      <div className="relative z-10 w-full flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 w-full text-left">
          <div className="bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 flex items-center gap-2">
            ...
            <div>
              <p className="text-[7px] font-black uppercase tracking-wider opacity-40">Salida</p>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 flex items-center gap-2">
            ...
            <div>
              <p className="text-[7px] font-black uppercase tracking-wider opacity-40">Puesta</p>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 flex items-center gap-2">
            ...
            <div>
              <p className="text-[7px] font-black uppercase tracking-wider opacity-40">Prob. Lluvia</p>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-2.5 rounded-xl border border-white/5 flex items-center gap-2">
            ...
            <div>
              <p className="text-[7px] font-black uppercase tracking-wider opacity-40">Viento</p>
